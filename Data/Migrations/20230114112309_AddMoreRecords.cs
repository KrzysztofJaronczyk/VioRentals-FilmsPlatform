...
namespace VioRentals.Data.Migrations
{
    public partial class AddMoreRecords : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Avatar', '2009-12-18', '2023-01-27', 6, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Aliens', '1986-07-18', '2023-01-27', 6, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Alien', '1979-05-25', '2023-01-27', 6, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Alien 3', '1992-05-22', '2023-01-27', 6, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Alien: Resurrection', '1997-09-07', '2023-01-27', 6, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Terminator 2: Judgment Day', '1991-07-03', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Terminator 3: Rise of the Machines', '2003-07-02', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Terminator Salvation', '2009-05-21', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Terminator Genisys', '2015-07-01', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Alien vs. Predator', '2004-08-06', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Alien vs. Predator: Requiem', '2007-08-09', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Predator', '1987-06-12', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Predator 2', '1990-07-12', '2023-01-27', 15, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Predators', '2010-07-07', '2023-01-27', 1, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Avengers: Infinity War', '2018-04-27', '2018-04-27', 1, 1)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Avengers: Endgame', '2019-04-26', '2019-04-26', 1, 1)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Pirates of the Caribbean: The Curse of the Black Pearl', '2003-07-09', '2023-01-27', 5, 3)");
            ...
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('E.T. the Extra-Terrestrial', '1982-06-11', '2023-01-27', 5, 2)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Indiana Jones and the Last Crusade', '1989-05-24', '2023-01-27', 5, 4)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Indiana Jones and the Temple of Doom', '1984-05-23', '2023-01-27', 5, 4)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Indiana Jones and the Kingdom of the Crystal Skull', '2008-05-22', '2023-01-27', 5, 4)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Indiana Jones and the Raiders of the Lost Ark', '1981-06-12', '2023-01-27', 5, 4)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Zoolander', '2001-02-16', '2023-01-27', 5, 5)");
            ...
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Apollo 13', '1995-06-30', '2023-01-27', 5, 7)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Right Stuff', '1983-12-17', '2023-01-27', 5, 7)");
            ...
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Big Bang Theory', '2007-09-24', '2023-01-27', 5, 8)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Interstellar', '2014-11-07', '2023-01-27', 5, 7)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Theory of Everything', '2014-11-26', '2023-01-27', 5, 7)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Imitation Game', '2014-11-14', '2023-01-27', 5, 7)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Social Network', '2010-10-01', '2023-01-27', 5, 7)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Wolf of Wall Street', '2013-12-25', '2023-01-27', 5, 7)");
            ...
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Grand Budapest Hotel', '2014-02-28', '2023-01-27', 5, 6)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('Life of Pi', '2012-11-21', '2023-01-27', 5, 6)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Hobbit: The Battle of the Five Armies', '2014-12-17', '2023-01-27', 5, 6)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Hobbit: The Desolation of Smaug', '2013-12-13', '2023-01-27', 5, 6)");
            migrationBuilder.Sql("INSERT INTO Movies (Name, ReleaseDate, DateAdded, NumberInStock, GenreId) VALUES ('The Hobbit: An Unexpected Journey', '2012-12-14', '2023-01-27', 5, 6)");
